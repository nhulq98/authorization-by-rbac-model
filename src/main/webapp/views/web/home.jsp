    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <%--                <c:forEach var = "i" begin = "0" end = "3">--%>
                <%--                    <a href="#" class="list-group-item">${newsModels.get(i).getTitle()}</a>--%>
                <%--                </c:forEach>--%>
            ...
            <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="<c:url value="/image/img1.jpg"/>" alt="First slide">
                    </div>

                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="<c:url value="/image/img2.jpg"/>" alt="Second slide">
                    </div>
               <div class="carousel-item">
                        <img class="d-block img-fluid" src="<c:url value="/image/img3.jpg"/>" alt="Third slide">
                    </div>
                </div>
                ...
                <c:forEach var="i" begin="0" end="1">
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">
                            <a href="#"><img class="card-img-top" src="<c:url value="/image/img4.jpg"/>" alt=""></a>
                            <div class="card-body">
                                <h4 class="card-title">
