...
<%--                        <button onclick="window.location.href='#'" type="button" class="btn btn-success">add</button>--%>
                            <button onclick="window.location.href='#'" class="btn"><a href="/admin-new?action=edit-post" class="fa fa-edit"></a></button>
                            <button onclick="window.location.href='#'" class="btn"><a href="/admin-new?action=delete-post" class="fa fa-trash"></a></button>
                        </td>
                    </tr>
                </c:forEach>
            </table>
